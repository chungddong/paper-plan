...
public class 리프라이언HP : MonoBehaviour
{
    public static 리프라이언HP instance;
    public int maxMHP = 0;
    public int MHP = 0;
    ...
    public void 몬스터체력초기화()
    {
        ...
        {
            maxMHP = 90 + StatManager.Statinstance.레벨 * 7;
            몬공격력 = 6 + StatManager.Statinstance.레벨 ;
    ...
    void Update()
    {
        ...
        if (MHP <= 0)
        {
            if (Playbutton.instance.몬스터번호 == 15)
            {
                MonsterDie.instance.죽은몬스터번호 = 15;
