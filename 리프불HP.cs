...
public class 리프불HP : MonoBehaviour
{
    public static 리프불HP instance;
    public int maxMHP = 0;
    public int MHP = 0;
    ...
    public void 몬스터체력초기화()
    {
        ...
        {
            maxMHP = 110 + StatManager.Statinstance.레벨 * 11;
            몬공격력 = 5 + StatManager.Statinstance.레벨/3;
    ...
    void Update()
    {
        ...
        if (MHP <= 0)
        {
            if (Playbutton.instance.몬스터번호 == 14)
            {
                MonsterDie.instance.죽은몬스터번호 = 14;
