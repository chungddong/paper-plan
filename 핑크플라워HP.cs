...
public class 핑크플라워HP : MonoBehaviour
{
    public static 핑크플라워HP instance;
    public int maxMHP = 0;
    public int MHP = 0;
    ...
    public void 몬스터체력초기화()
    {
        ...
        {
            maxMHP = 100 + StatManager.Statinstance.레벨 * 9;
            몬공격력 = 5 + StatManager.Statinstance.레벨/2;
    ...
    void Update()
    {
        ...
        if (MHP <= 0)
        {
            if (Playbutton.instance.몬스터번호 == 11)
            {
                MonsterDie.instance.죽은몬스터번호 = 11;
